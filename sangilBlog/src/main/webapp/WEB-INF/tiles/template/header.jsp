...
<div style="background-color: #ffffff; height:6em;">
  	...
  	<div class="float-right mr-3 mt-3"> 
  		<i class="fa fa-github fa" aria-hidden="true"></i><span class="badge badge-light" style="cursor:hand" onclick="javascript:window.open('https://github.com/ChoiSangIl', '_blank')">https://github.com/ChoiSangIl</span>
